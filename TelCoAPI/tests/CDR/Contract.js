...
/**
 * Test for /CDR/Contract
 */
Test('/CDR/Contract', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test CreateDeployContract post operation', function (t) {
            Mockgen().requests({
                path: '/CDR/Contract',
                operation: 'post'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/CDR/Contract']['post']['responses']['200']['schema']);
