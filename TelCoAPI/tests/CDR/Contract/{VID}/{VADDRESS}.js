...
/**
 * Test for /CDR/Contract/{VID}/{VADDRESS}
 */
Test('/CDR/Contract/{VID}/{VADDRESS}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test GETCDRBYIDANDADDR get operation', function (t) {
            Mockgen().requests({
                path: '/CDR/Contract/{VID}/{VADDRESS}',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/CDR/Contract/{VID}/{VADDRESS}']['get']['responses']['200']['schema']);
